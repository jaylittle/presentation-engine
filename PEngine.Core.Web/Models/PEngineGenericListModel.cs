...
namespace PEngine.Core.Web.Models
{
  ...
  {
    public PEngineGenericListModel(IServiceProvider svp, HttpContext context, PEnginePage page, bool hideSubTitle = false, IEnumerable<T> listData = null, string currentSection = null, int? currentPage = null)
    {
      Settings = PEngine.Core.Shared.Settings.Current;
      State = new PEngineStateModel(svp, Settings, context, page, hideSubTitle, (IEnumerable<ISubTitleModel>)listData, currentSection, currentPage);
      ListData = listData;
    }
