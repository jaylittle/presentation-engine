...
To get started, simply click on the "Login" button in the upper right hand corner of the screen.  The password is "pengine".  Please change this as soon as possible by clicking the "Settings" button after logging in.  Not changing it constitutes a major security hole and will leave your site open to unauthorized changes from malicious visitors!

Regards,

Jay Little
Creator of PEngine', datetime('2017-05-15 00:00:00'), datetime('2017-05-15 00:00:00'));
