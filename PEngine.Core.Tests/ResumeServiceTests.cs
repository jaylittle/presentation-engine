  ...
  public class ResumeServiceTests
  {
    ...
    public async Task ResumeService_Upsert_ObjectIsValidated()
    {
      ...
      Assert.False(await TestHelpers.CallProducedError(async() =>
          await resumeService.UpsertResume(resumeData)
        , ResumeService.RESUME_ERROR_DATA_MUST_BE_PROVIDED));
    }

    [Fact]
    public async Task ResumeService_Upsert_Personal_GuidIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Personal_FullNameIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Personal_EmailIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Personal_RecordRequired()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Objective_GuidIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Objective_ContentIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Objective_RecordRequired()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Skill_GuidIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Skill_TypeIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Skill_NameIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Education_GuidIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Education_InstituteIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Education_ProgramIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_Education_StartedIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_WorkHistory_GuidIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_WorkHistory_EmployerIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_WorkHistory_JobTitleIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_WorkHistory_JobDescriptionIsValidated()
    {
    ...
    [Fact]
    public async Task ResumeService_Upsert_WorkHistory_StartedIsValidated()
    {
